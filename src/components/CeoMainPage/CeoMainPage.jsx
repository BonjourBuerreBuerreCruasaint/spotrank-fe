...
const CeoMainPage = () => {
  ...
  const fetchPlacesFromAPI = useCallback(async () => {
    try {
      ...
      const seoulDataResponse = await fetch('http://a0d594b85a2bc445d8fefaeaa3100e5f-1256827131.ap-northeast-2.elb.amazonaws.com:5000/api/seouldata');
  ...
  const fetchPopulationData = useCallback(async () => {
    try {
      ...
      const response = await fetch('http://a0d594b85a2bc445d8fefaeaa3100e5f-1256827131.ap-northeast-2.elb.amazonaws.com:5000/api/jinfinalpeople');
  ...
  const fetchNewPolygonData = useCallback(async () => {
    try {
      const response = await fetch('http://a0d594b85a2bc445d8fefaeaa3100e5f-1256827131.ap-northeast-2.elb.amazonaws.com:5000/api/colored-zones');
