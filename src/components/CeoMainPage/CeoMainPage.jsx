...
const CeoMainPage = () => {
  ...
  const fetchPlacesFromAPI = useCallback(async () => {
    try {
      ...
      const seoulDataResponse = await fetch('http://a80625590af6d4acf82ca715b842e927-1758367468.ap-northeast-2.elb.amazonaws.com:5000/api/seouldata');
  ...
  const fetchPopulationData = useCallback(async () => {
    try {
      ...
      const response = await fetch('http://a80625590af6d4acf82ca715b842e927-1758367468.ap-northeast-2.elb.amazonaws.com:5000/api/jinfinalpeople');
  ...
  const fetchNewPolygonData = useCallback(async () => {
    try {
      const response = await fetch('http://a80625590af6d4acf82ca715b842e927-1758367468.ap-northeast-2.elb.amazonaws.com:5000/api/colored-zones');
